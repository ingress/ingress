...
var Server = (function (_AppBuilder) {
  function Server() {
    var webserver = arguments[0] === undefined ? new _HttpServerJs.HttpServer() : arguments[0];
    var environmentFactory = arguments[1] === undefined ? function (x) {
  ...
  _createClass(Server, [{
    ...
    value: function listen() {
      ...
      this.webserver.onRequest(function (req, res) {
        appFn.call(_this, _this.createEnvironment({ req: req, res: res }));
      });
