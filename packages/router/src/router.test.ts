...
// test('readUrl', () => {
//   t.equal(readUrl('/hello/world?whats=up'), ['/hello/world', '?whats=up'])
//   t.equal(readUrl('/hello/world#whats=up'), ['/hello/world', '?whats=up'])
//   t.equal(readUrl('/hello/world;whats=up'), ['/hello/world', '?whats=up'])
//   t.equal(readUrl(''), ['/', ''])
// })

// test('Route miss', async () => {
...
// test('Route Execution with Annotations', async () => {
//   const router = new Router()
//   let called = false,
//     finished = false
...
// test('Route Execution with plain Metadata', async () => {
//   const router = new Router()
//   let called = false,
//     finished = false
//   class Routes {
...
// test('accepts upgrade route', async () => {
//   class Routes {
//     @Upgrade()
//     somepath() {
//       void 0
...
// test('errors without setup (start)', async () => {
//   const router = new Router()
//   t.plan(1)
//   try {
//     router.middleware
...
// test('priority middleware order', async () => {
//   t.plan(2)
